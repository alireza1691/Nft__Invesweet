...
useEffect (() => {
  ...
  async function generate(params) {
    const contractInstance = new ethers.Contract("0xaff6b98ea4dff833ca91dda2c3c0e9c6a5b090aa",CreatorC, signer)
  ...
  return (
    ...
    <div>
        ...
        <input className='input' placeholder='Enter name...' style={{"color":"black","width":"50%","margin":"5px"}} onChange={(e) => setName(e.target.value) }></input>
        <input className='input' placeholder='Enter symbol...' style={{"color":"black","width":"50%","margin":"5px"}} onChange={(event) => setSymbol(event.target.value)} ></input>
        <input className='input' placeholder='Enter price...' style={{"color":"black","width":"50%","margin":"5px"}} onChange={(e) => setPrice(e.target.value)} ></input>
        <input className='input' placeholder='Enter max supply...' style={{"color":"black","width":"50%","margin":"5px"}} onChange={(e) => setMaxSupply(e.target.value)} ></input>
